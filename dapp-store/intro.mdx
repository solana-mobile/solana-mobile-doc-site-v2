...
<CardGroup>
  <Card title="Publish your dApp" icon="/images/static/img/rocket-icon2.png" href="/dapp-store/publishing-cli/overview">
    Follow the step-by-step guide to publish your app to the Solana dApp Store.
  </Card>
  <Card title="Convert a PWA to an APK" icon="/images/static/img/pwa-icon.png" href="/recipes/general/publishing-a-pwa">
...
<CardGroup>
  <Card title="Publish a dApp" icon="rocket-launch" href="/dapp-store/publishing-cli/overview">
    Follow the step-by-step guide to publish your app to the Solana dApp Store.
  </Card>
  <Card title="Progressive Web Apps (PWAs)" icon="globe" href="/recipes/general/publishing-a-pwa">
    Learn how to convert a PWA to an Android app and publish on the dApp Store.
  </Card>
  <Card title="Frequently Asked Questions" icon="question" href="/dapp-store/qanda">

...
<CardGroup>
  <Card title="Publish your dApp" icon="/images/static/img/rocket-icon2.png" href="/dapp-store/submit-new-app">
    Follow the step-by-step guide to publish your app to the Solana dApp Store.
  </Card>
  <Card title="Convert a Web App to an APK" icon="/images/static/img/pwa-icon.png" href="/recipes/general/publishing-a-web-app">
    Learn how to wrap a web app to an Android app with Web Shell and publish on the dApp Store.
  </Card>
</CardGroup>
...
<CardGroup>
  ...
  <Card title="Web Apps" icon="globe" href="/recipes/general/publishing-a-web-app">
    Learn how to wrap a web app to an Android app with Web Shell and publish on the dApp Store.
  </Card>

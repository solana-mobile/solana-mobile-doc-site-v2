---
title: "Mint your App NFT"
description: "If this is your first time publishing an app on the dApp Store, then you will need to mint a an **App NFT**."
sidebarTitle: "3. Mint your App NFT"
---
...
If you are looking to publish an update version of an existing app, then skip to [this step](/dapp-store/publishing_releases).
</Tip>
...
If you have `.mp4` video assets in your publishing, make sure you have `ffmpeg` utility library [installed](/dapp-store/publishing-cli/setup#ffmpeg).
</Note>

...
<CardGroup>
<Card title="Publisher Policy" horizontal icon="globe" href="/dapp-store/publisher-policy"/>
<Card title="Developer Agreement" horizontal icon="code" href="/dapp-store/publisher-policy"/>
</CardGroup>
...
To get started with dApp publishing, you can begin following the [step-by-step guide](/dapp-store/publishing-cli/setup) or watch this video tutorial:

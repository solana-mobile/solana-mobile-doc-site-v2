...
<Frame caption="Info dialog shown before the browser permission prompt.">
  <img src="/images/static/img/mwa-lna-dialog1.png" alt="Info dialog" style={{ maxWidth: '360px', margin: '0 auto' }} />
</Frame>
...
<Frame caption="Browser permission prompt for local network access.">
  <img src="/images/static/img/mwa-lna-prompt.png" alt="Browser permission prompt" style={{ maxWidth: '360px', margin: '0 auto' }} />
</Frame>
...
<Frame caption="Success dialog after granting the permission.">
  <img src="/images/static/img/mwa-lna-dialog2.png" alt="Success dialog with connect wallet button" style={{ maxWidth: '360px', margin: '0 auto' }} />
</Frame>

...
<CardGroup cols={2}>
  <Card title="SKR Staking" icon="coins" href="/recipes/solana-development/skr-staking-core-functions">
    Core SKR staking flow: query balances, read stake state, stake, unstake, and withdraw SKR.
  </Card>

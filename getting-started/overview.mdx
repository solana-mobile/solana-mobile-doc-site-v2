...
[**Mobile Wallet Adapter (MWA)**](https://github.com/solana-mobile/mobile-wallet-adapter) is a protocol specification for connecting mobile dApps to mobile Wallet Apps, enabling communication for Solana transaction and message signing.
...
Check out the [2.0 migration guide](/mwa/migration/overview) to migrate from 1.x vresion of Mobile Wallet Adapter to the latest version. 

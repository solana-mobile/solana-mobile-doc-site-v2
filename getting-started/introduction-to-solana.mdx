...
To learn more about Solana's core concepts see the [Solana Docs](https://docs.solana.com/). These are official docs about fundmental concepts about Solana like network architecture, Solana _accounts_, _transactions_, and on-chain programs.

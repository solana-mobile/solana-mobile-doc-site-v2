...
If you are implementing this flow within a mobile app, you will need to manually implement SIWS using [Mobile Wallet Adapter](/get-started/react-native/quickstart) (`authorize` + `signMessage`).

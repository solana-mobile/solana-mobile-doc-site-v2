...
<Frame>
  <img src="/images/static/blog_imgs/chapter2-preorder-token.jpeg" alt="Preorder Token" width="300" />
</Frame>
...
Each Chapter 2 Preorder Token NFT utilizes the [Metadata and Metadata Pointer](https://solana.com/developers/guides/token-extensions/metadata-pointer) extension to define its NFT metadata.

...
<CardGroup cols={2}>
  <Card title="Progressive Web Apps (PWAs)" icon={<img src="/images/static/img/pwa-icon.png" width={24} height={24} />} href="/dapp-publishing/publishing-a-pwa">
...
<CardGroup cols={2}>
  <Card title="dApp Store" icon="mobile" href="/dapp-publishing/intro">

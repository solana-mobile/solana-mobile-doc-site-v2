...
<CardGroup cols={2}>
  ...
  <Card horizontal title="Mobile Web" icon="globe" href="/mobile-wallet-adapter/web-installation" />
  <Card horizontal title="Flutter" icon="flutter" href="/flutter/overview" />
  <Card horizontal title="Unity" icon="unity" href="/unity/unity_sdk" />
  <Card horizontal title="Unreal" icon="/images/static/img/unreal-logo.png" href="/unreal/unreal_sdk" />
</CardGroup>

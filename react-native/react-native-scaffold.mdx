...
<Button href="https://github.com/solana-mobile/solana-mobile-dapp-scaffold">View on GitHub</Button>

## Prerequisites

- React Native and Android Envrionment [setup](/developers/development-setup)

...
<Button href="https://github.com/solana-mobile/tutorial-apps/tree/main/MobileNFTMinter">View on Github</Button>
...
<Step>
Upload a JSON object containing metadata that conforms to the [Metaplex NFT Standard](https://docs.metaplex.com/programs/token-metadata/token-standard#the-non-fungible-standard), to a storage provider.
</Step>
<Step>
